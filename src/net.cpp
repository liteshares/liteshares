...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "LiteShares " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"web01", "115.28.163.168"},
    {"web02", "115.28.100.122"},
    {"web03", "115.29.136.229"},
    {"web04", "115.28.137.148"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. LiteShares is probably already running."), addrBind.ToString().c_str());
        else
